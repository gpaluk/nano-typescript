...
export class Tweener {
    private static _removeList: Tween[] = new Array<Tween>()
    private static _pendingTweens: Tween[] = new Array<Tween>()
    private static _tweenList: Tween[] = new Array<Tween>()
    ...
    public static removeTween(tween: Tween, list: Tween[]): void {
